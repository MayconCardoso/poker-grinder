...
internal class RegisterFlipViewModelTest : BaseViewModelTest() {
  ...
  fun `should select first hero card`() {
    ...
    val initialState =
      RegisterFlipState(currentFlow = RegisterFlipFlow.HERO_CARD_PICKER)
  ...
  fun `should select first villain card`() {
    val cards = listOf(Card(suit = CardSuit.CLUBS, name = "A", value = 14))
    val initialState =
      RegisterFlipState(currentFlow = RegisterFlipFlow.VILLAIN_CARD_PICKER)
  ...
  fun `should select first board card`() {
    val cards = listOf(Card(suit = CardSuit.CLUBS, name = "A", value = 14))
    val initialState =
      RegisterFlipState(currentFlow = RegisterFlipFlow.BOARD_PICKER)
  ...
  private fun unselectCardFlow(currentFlow: RegisterFlipFlow) = observerScenario {
    ...
    val initialState =
      RegisterFlipState(currentFlow = currentFlow,
        disableCards = listOf(card))
