package com.mctech.pokergrinder.bankroll.presentation.deposit.composables
...
import com.mctech.pokergrinder.bankroll.presentation.deposit.DepositInteraction
...
@Composable
internal fun DepositUi(
  interact: (DepositInteraction) -> Unit = {}
) {
  // Hold fields value.
  ...
  Column(modifier = Modifier.fillScreen()) {
    // Render title
    Text(
      text = stringResource(id = R.string.bankroll_deposit),
