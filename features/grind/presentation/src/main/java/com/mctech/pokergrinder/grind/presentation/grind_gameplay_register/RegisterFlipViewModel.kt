...
internal class RegisterFlipViewModel @Inject constructor(
  ...
  private fun onTournamentEvent(interaction: GrindDetailsInteraction.OnTournamentEvent) {
    // Holds the selected tournament
    val event = interaction.event as? GrindDetailsConsumerEvent.TournamentClicked ?: return
